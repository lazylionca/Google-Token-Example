...
If you're anything like me, you want to know how things work rather than just blindly use someone else's library.

I'll admit, I don't know how to build a combustion engine, but I do know how to change my own oil and spark plugs.

Libraries are great when you are working on big projects and don't want to re-invent the wheel.
But I'm not building a car here.

My goal was simple, look up a phone number in my Google Contacts and get the associated name if it exists.
...
Which, yes, is probably the most common usage, but...
...
if you haven't already. This is how Google tracks who/what is accessing a users account.
